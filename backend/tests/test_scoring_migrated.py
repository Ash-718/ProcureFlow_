# The AI service's own scoring tests, carried over unchanged.
#
# Only the import path differs (app.services.scoring -> app.ai.scoring);
# every assertion below is verbatim from ai-service/tests/test_scoring.py.
# Passing here is the proof that the weighted formula survived the migration:
# these tests were written against the original implementation and know
